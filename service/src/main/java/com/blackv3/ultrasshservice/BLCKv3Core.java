...
* @author YourName
*/
public class BLCKv3Core
{
	private static BLCKv3Core mInstance = null;
	private Context mContext;
	
	public static void init(Context context) {
		if (mInstance == null) {
			mInstance = new BLCKv3Core(context);
		}
	}
	
	private BLCKv3Core(Context context) {
		mContext = context;
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(BLCKv3Service.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(BLCKv3Service.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
        ...
        mChannel = new NotificationChannel(BLCKv3Service.NOTIFICATION_CHANNEL_USERREQ_ID,

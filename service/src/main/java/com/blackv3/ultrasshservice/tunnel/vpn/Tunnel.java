...
package com.blackv3.ultrasshservice.tunnel.vpn;
			...
			boolean enabledFilter, boolean filterBypassMode, String[] filterApps, boolean enableTethering) throws java.lang.Exception
	{
		...
		try
		{
			...
			if (Build.VERSION.SDK_INT >= 21) {
				builder.addDisallowedApplication("socksrevive.plugin.dragon");
			...
			tunFd = builder
					...
					.setConfigureIntent(BLCKv3Service.getGraphPendingIntent(mHostService.getContext()))
					.establish();

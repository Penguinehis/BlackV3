...
{
	public static final String EXTRA_HIDELOG = "com.blackv3.br.showNoLogWindow";
	...
	private void showLogWindow() {
		Intent updateView = new Intent("com.blackv3.br:openLogs");
		...
		if (requestCode == START_VPN_PROFILE) {
			if (resultCode == Activity.RESULT_OK) {
				...
				if (!TunnelUtils.isNetworkOnline(this)) {
					...
					TunnelManagerHelper.startBLCKv3(this);

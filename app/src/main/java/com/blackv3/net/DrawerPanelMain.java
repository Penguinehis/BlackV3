	...
	implements NavigationView.OnNavigationItemSelectedListener
{
	...
	public boolean onNavigationItemSelected(@NonNull MenuItem item) {
		...
		switch(id)
		{
			...
			case R.id.miContato:
				String url1 = "https://www.app-https://ww.worldofdragon.net/.online/";
			...
			/*case R.id.miAvaliarPlaystore:
				String url = "https://play.google.com/store/apps/details?id=com.blackv3.net";
			...
			case R.id.miSendFeedback:
				if (false && Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
					...
					email.putExtra(Intent.EXTRA_SUBJECT, "BLCKv3 - " + mActivity.getString(R.string.feedback));
